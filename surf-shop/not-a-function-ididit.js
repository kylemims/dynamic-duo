...
const convertDataForAccounting = (productArray) => {
    // we need this function to convert the input to all upper case???
    // create a loop
    for (let product of productArray) {
    console.log(`${product.description} - ${product.type} - ${product.price}`.toUpperCase())
    } 
    
    
}
//for (let upperPrice of productArray) {
    //console.log(upperPrice.price.toUpperCase())

    
        
 // }  //we need to access each property of the array's objects
